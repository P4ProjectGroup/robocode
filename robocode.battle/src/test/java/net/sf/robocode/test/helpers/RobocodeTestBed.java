...
public abstract class RobocodeTestBed extends BattleAdaptor {
	...
	static {
		...
		try {
			...
			if (currentDirAbsolutePath.endsWith("robocode.battle")) {
				robotsPath = new File("../robocode.battle.testRobots").getCanonicalPath();
		...
		System.setProperty("ROBOTPATH", robotsPath + "/target/test-classes");
